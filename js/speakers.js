$(document).ready(function(){
    ...
    $("#ind_container_3").click(function() {
        setTimeout(function() {
            document.getElementById('ind_container_3').style.backgroundImage = 'url(./images/speakers/bw/7_darchite.jpg)';
        }, 100);
    });
    $("#ind_container_4").click(function() {
        setTimeout(function() {
            document.getElementById('ind_container_4').style.backgroundImage = 'url(./images/speakers/bw/14_joao.jpg)';
        }, 100);
    });
    ...
    $("#ind_container_7").click(function() {
        setTimeout(function() {
            document.getElementById('ind_container_7').style.backgroundImage = 'url(./images/speakers/bw/2_miguel.jpg.jpg)';
        }, 100);
    });
    ...
    function toggle_color(){
        ...
        document.getElementById('ind_container_7').style.backgroundImage = 'url(./images/speakers/2_miguel.jpg.jpg)';    
